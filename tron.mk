# Code generated by tron v0.28.0-rc1.0. DO NOT EDIT.
# You can extend or override anything in ./Makefile

LOCAL_BIN:=$(CURDIR)/bin

DOCKERFILE   = build/Dockerfile
DOCKER_IMAGE = gadavy/tx-example

VERSION  := $(shell git describe --tags --always)
GIT_HASH := $$(git rev-parse HEAD)
BUILD_TS := $(shell date +%FT%T%z)

LDFLAGS := -X 'github.com/loghole/tron/internal/app.ServiceName=tx-example' \
		   -X 'github.com/loghole/tron/internal/app.AppName=github.com/gadavy/tx-example' \
...
.PHONY: docker-run
docker-run:
	${DOCKER_COMPOSE_RUN} run --rm --service-ports app /bin/sh -c "go run -ldflags \"$(LDFLAGS)\" cmd/tx-example/main.go"
